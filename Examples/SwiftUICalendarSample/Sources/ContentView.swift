...
struct ContentView: View {
    ...
    @State private var viewModel = CalendarViewModel(calendarIdentifier: .gregorian, selection: .single(Date()))
    ...
    private func applyConfiguration() {
        ...
        case .square:
            ...
            if calendarIdentifier == .persian {
                ...
                theme.day.useSquareDualCalendarDayView(secondaryLabel: .custom { date in
