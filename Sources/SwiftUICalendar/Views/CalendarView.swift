...
/// A configurable calendar view with header and body layouts.
...
private struct CalendarPreviewConfigurator: View {
    ...
    @State private var previewModel = CalendarViewModel(calendarIdentifier: .gregorian, selection: .single(Date()))
