...
struct SquareDualCalendarDayView: CalendarDayView {
    ...
    private var borderColor: Color {
        context.isToday ? dayTheme.todayBorderColor : dayTheme.emptyDayBorderColor
    }

    private var borderWidth: CGFloat {
        context.isToday ? dayTheme.todayBorderColorWidth : dayTheme.emptyDayBorderColorWidth
    }
